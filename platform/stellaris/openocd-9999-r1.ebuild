...
LICENSE="GPL-2"
SLOT="0"
IUSE="blaster dummy ftd2xx ftdi minidriver parport presto segger ti-icdi usb versaloon"
...
src_prepare() {
	if [[ ${PV} == "9999" ]] ; then
		...
		git fetch http://openocd.zylin.com/openocd refs/changes/22/922/6 && git checkout FETCH_HEAD || die
